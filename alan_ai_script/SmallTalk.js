...
question(
    ...
    reply('(I\'m good|I think you know it very well)'),
);
...
question(
    ...
    reply('I know. (And I appreciate your sentiment|I Know|)')
);
...
question(
    ...
    'You are slow',
    'I am waiting',
    reply('(I\'m going as fast as I can. (Check your connection|Calm Down|)|thats what she said)'),
);

question(
    'I (would|will) (like to|) see you $(Q again|later)',
    reply('See you $(Q again|later|will be waiting)'),
);
...
question(
    'I (just|) want to talk',
    reply('OK, let\'s talk. (What\'s on your mind?|I am an news AI)'),
);
...
question(
    'Who is ravi singh',
    reply('he is a brilliant, playboy, billionaire, philanthropist and my boss'),
);
...
question(
    'That\'s bad',
    reply('Sorry to hear (that|). (Let me know how I can help|You too.)'),
);
...
question(
    ...
    reply('I can\'t answer that|stop being a pervert'),
);
